"use strict";
(self["webpackChunktodolist"] = self["webpackChunktodolist"] || []).push([["Task"],{
...
class Task {
    ...
    getDueDate() {
        let date = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'EEEE, dd MMM yyyy');
        if (this.dueDate === '')
            this.dueDate = date;
        else 
            this.dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(this.dueDate), 'EEEE, dd MMM yyyy');
        return this.dueDate;
    }
